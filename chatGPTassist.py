...
def checkStory(script):
    ...
    prompt2=f"""Now that you have learned this story I need you to follow these steps to generate me a better story!
                ...
                5. After that maintain or increase the length of the script to about 200 words while retaining the hook and title.
    ...
    prompt6=f"Now print it again and don't repeat my instructions this time!"

    client = Client()
    response = client.chat.completions.create(
        model="gpt-4",
        messages=[{"role": "user", "content": prompt1},{"role": "user", "content": prompt2},{"role": "user", "content": prompt3},{"role": "user", "content": prompt4},{"role": "user", "content": prompt5},{"role": "user", "content": prompt6}],
    )

    betterTxt = response.choices[0].message.content
